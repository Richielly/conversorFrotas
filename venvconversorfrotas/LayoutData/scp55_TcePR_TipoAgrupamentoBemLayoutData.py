...
_layout = scp55_TcePR_TipoAgrupamentoBemLayout.Scp55_TcePR_TipoAgrupamentoBemLayout()
_log = log.Log()
_path_file = path_dir + _core.step['Scp55_TcePR_TipoAgrupamentoBem'][3]
...
class Scp55_TcePR_TipoAgrupamentoBemLayoutData:
    ...
    def exist(self, IDTIPONATUREZABEM, IDTIPOCATEGORIABEM, IDTPDETALHAMENTOBEM, IDTIPOUTILIZACAOBEM):
        try:
            cursor = conn.connection()
            script = f" select * from SCP55_TCEPR_TIPOAGRUPAMENTOBEM  where IDTIPONATUREZABEM = '{IDTIPONATUREZABEM}' and IDTIPOCATEGORIABEM = '{IDTIPOCATEGORIABEM}' and IDTPDETALHAMENTOBEM = '{IDTPDETALHAMENTOBEM}' and IDTIPOUTILIZACAOBEM = '{IDTIPOUTILIZACAOBEM}' "
    ...
    def insert_data(self, values, homologacao=False):
        try:
            ...
            query = f"INSERT INTO SCP55_TCEPR_TIPOAGRUPAMENTOBEM ({columns}) VALUES ({value})"
            ...
            return f"Erro ao tentar inserir o dado na tabela SCP55_TCEPR_TIPOAGRUPAMENTOBEM: {e}"
